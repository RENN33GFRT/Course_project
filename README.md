...
git clone https://github.com/RENN33GFRT/Course_project
...
Настройка
Данные пользователя: Отредактируйте user_settings.json для настройки:

user_currencies: Список валют (например, ["USD", "EUR"]).

user_stocks: Список акций (например, ["AAPL", "TSLA"]).

Логирование: Логи сохраняются в папке logs/ для каждого модуля.
